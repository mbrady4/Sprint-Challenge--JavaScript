...
const unisWithUni = graduates.filter(function(student) {
  return student.university.includes('Uni');
});
...
*/
// const displayNames = zooAnimals.map(animal => `Name: ${animal.animal_name}, Scientific: ${animal.scientific_name}`);
